...
class Vector:
    ...
    def __mul__(self, other):
        """ Multiply Vector*Vector (dot product). """
...
def angle(vec1, vec2):
    ...
    dot = vec1 * vec2
    return math.acos((vec1 * vec2) / round(vec1.length() * vec2.length(), 9))
...
if (__name__ == "__main__"):
    ...
    test("Vector(1, 2, 3) - 10",                         "Vector(-9.0, -8.0, -7.0)")
    ...
    test("pow(Vector(1, 0, 0), Vector(0, 1, 0))",        "Vector(0.0, 0.0, 1.0)")
    test("angle(Vector(1, 0, 0), Vector(0, 1, 0))",      "1.57079632679")
    test("angle(Vector(0, 1, 0), Vector(1, 0, 0))",      "1.57079632679")
    test("angle(Vector(1, 0, 0), Vector(1, 1, 0))",      "0.785398163134")
    test("angle(Vector(1, 1, 1), Vector(-1, 0, 0))",     "2.18627603529")
    test("angle(Vector(1, 1, 0), Vector(-1, -1, 0))",    "3.14159265359")
    test("angle(Vector(0, 1, 1), Vector(0, 1, 0))",      "0.785398163134")
    test("angle(Vector(1, 1, 1), Vector(-1, -1, -1))",   "3.14159265359")
